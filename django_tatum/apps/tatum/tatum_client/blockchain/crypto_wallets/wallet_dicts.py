...
from django_tatum.apps.tatum.tatum_client.blockchain.crypto_wallets.ethereum import EthereumWallet
from django_tatum.apps.tatum.tatum_client.blockchain.crypto_wallets.matic import PolygonMatic
from django_tatum.apps.tatum.tatum_client.blockchain.crypto_wallets.solana import SolanaWallet
